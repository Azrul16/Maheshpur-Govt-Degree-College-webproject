...
// Assign Transaction Information
            ...
            $transaction_amount = 6000;//$api_response['transaction']['amount']; // bKash Payment Amount

            $transaction_reference = $api_response['transaction']['reference']; // bKash Reference for Invoice ID

            $transaction_time = null;//$api_response['transaction']['trxTimestamp']; // bKash Transaction Time & Date
