  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNavDropdown">
      <ul class="navbar-nav  ml-auto  mb-2">
        ...
        <li class="nav-item">
          <a class="nav-link" href="faculty_members.php"  style="color: black; font-weight: 700">Teachers</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="course.php"  style="color: black; font-weight: 700">Departments</a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link" href="form.php" style="color: black; font-weight: 700">Admission Form</Form></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="admin/admin.php" style="color: black; font-weight: 700">Login</a>
        </li>
        <!-- <li class="nav-item">
          <div class="dropdown">
